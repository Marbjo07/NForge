...
BENCHMARK(BM_TensorAdd_1000_1000)->MinTime(2.0);
...
BENCHMARK(BM_TensorAdd_Broadcast_1000)->MinTime(2.0);
...
BENCHMARK(BM_TensorAdd_ViewOffset_1000_1000)->MinTime(2.0);
...
BENCHMARK(BM_TensorAdd_ViewStrided_1000_1000)->MinTime(2.0);
...
BENCHMARK(BM_TensorAddInplace_1000_1000)->MinTime(2.0);
...
BENCHMARK(BM_TensorAddInplace_ViewOffset_1000_1000)->MinTime(2.0);
...
BENCHMARK(BM_TensorAddInplace_ViewStrided_1000_1000)->MinTime(2.0);
...
BENCHMARK(BM_TensorReduction_Sum_1000_1000)->MinTime(2.0);
