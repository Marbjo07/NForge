...
BENCHMARK(BM_PhysicalOffset_2D_1000)->MinTime(2.0);
...
BENCHMARK(BM_PhysicalOffset_3D_100)->MinTime(2.0);
...
BENCHMARK(BM_PhysicalOffset_Broadcast_1000)->MinTime(2.0);
...
BENCHMARK(BM_PhysicalOffset_Strided_1000)->MinTime(2.0);
