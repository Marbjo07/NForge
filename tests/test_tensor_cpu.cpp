...
TEST_CASE("Create tensor", "[Tensor][CPU]") {
...
TEST_CASE("Compare tensor", "[Tensor][CPU]") {
...
TEST_CASE("Compare tensor views", "[Tensor][CPU]") {
    Tensor a({3, 9, 7}, 19.0f, Backend::CPU);
    Tensor b({3, 9, 7}, 19.0f, Backend::CPU);
...
TEST_CASE("Compare tensor and tensor view", "[Tensor][CPU]") {
    Tensor a({3, 9, 7}, 19.0f, Backend::CPU);
...
TEST_CASE("Add tensors", "[Tensor][CPU]") {
...
TEST_CASE("Subtract and multiply tensors", "[Tensor][CPU]") {
    Tensor a({3}, 4.0f, Backend::CPU);
    Tensor b({3}, 1.0f, Backend::CPU);
...
TEST_CASE("Broadcast scalar add", "[Tensor][CPU]") {
...
TEST_CASE("2D tensor shape and indexing", "[Tensor][CPU]") {
...
TEST_CASE("Tensor slice assign", "[Tensor][CPU]") {
